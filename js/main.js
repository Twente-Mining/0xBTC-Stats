...
const _BLOCKS_PER_READJUSTMENT = 20;
const _CONTRACT_ADDRESS = "0xdf7ab88f426d1776e8b271b2c722ccb0a0abd58c";
...
const _ETH_BLOCKS_PER_REWARD = 31;
...
function updateStatsThatHaveDependencies(stats) {
  ...
  el_safe('#SupplyRemaininginEra').innerHTML = "<b>" + supply_remaining_in_era.toLocaleString() + "</b> pep <span style='font-size:0.8em;'>(" + rewards_blocks_remaining_in_era + " blocks)</span>";
